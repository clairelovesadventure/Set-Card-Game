...
***
<p>
  <img src="https://courses.cs.washington.edu/courses/cse154/24au/homework/hw2/screenshots/spec-intro-view.png" width="60%" alt="Set! Game board">
</p>
...
<p>
  <img src="https://courses.cs.washington.edu/courses/cse154/24au/homework/hw2/screenshots/set-example.png" width="50%" alt="Example of something that is a set">
</p>
...
<p>
  <img src="https://courses.cs.washington.edu/courses/cse154/24au/homework/hw2/screenshots/not-set-example.png" width="50%" alt="Example of something that is not a Set">
</p>
...
**Both Cases**:
* For both cases, the three selected cards should lose the `.selected` appearance **immediately** just prior to the appropriate 1-second message displaying (refer to provided video demo linked above, also [here](https://courses.cs.washington.edu/courses/cse154/24au/homework/hw2/hw2.mp4)).
* Below is an example of the message displayed when an incorrect Set is selected:

  <img src="https://courses.cs.washington.edu/courses/cse154/24au/homework/hw2/screenshots/game-view-not-set.png" width="60%" alt="Not a Set display example">
